...
std::string format_event_text( const event & e, int n = 60 )
{
	//int n = 60; 
...
*/
				surface = decode_grib_to_surface( std::vector< unsigned char>( e.start, e.finish) ); 


				ptr< GtsHeader> header = new GtsHeader( ttaaii, cccc, yygggg, bbb ); 

				//surface->tags.push_back( header );
